...
#define NUM_TIMESCALE		19		//タイムスケースの種類の数
...
volatile extern uint16_t sample_length[5];
volatile extern timescalse_div_val_T timescale_div_val[NUM_TIMESCALE];		//[DIVE分周値][ADCHS Descriptor MATCHVALUE]
