...
#define USB_VID		0x1FC9	// NXP Semiconductors VID
#define USB_PID		0x8168	// PID for USBOscilloscope

// device descriptor bcdDevice にリビジョン情報を記載
#define BOARD_REVISION  0x0
#define FIRM_REVISION   0x0
#define BCD_DEVICE		((FIRM_REVISION<<8)|BOARD_REVISION)		//Descriptor bcdDevice 2byte
...
#define EP1_OUT_BINTERBAL 		4		// 4ms
#define EP2_IN_BINTERBAL		8		// 16ms
 ...
 */
#define USB_STACK_MEM_BASE      0x20001000
#define USB_STACK_MEM_SIZE      0x00001000	// 本当は1KBもあれば十分
