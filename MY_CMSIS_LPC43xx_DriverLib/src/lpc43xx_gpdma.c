...
const uint32_t GPDMA_LUTPerAddr[] = {
		...
		((uint32_t)&LPC_ADCHS->FIFO_OUTPUT[0]),	// ADCHS Write
		((uint32_t)&LPC_ADCHS->FIFO_OUTPUT[0])    // ADCHS Read
};
#endif
/**
...
const uint8_t GPDMA_LUTPerBurst[] = {
		...
		GPDMA_BSIZE_4,				// ADC 1
		GPDMA_BSIZE_1,				// DAC
		GPDMA_BSIZE_4,				// ADCHS Write
		GPDMA_BSIZE_4				// ADCHS Read
...
uint8_t DMAMUX_Config(uint32_t gpdma_peripheral_connection_number)
{
	...
	switch(gpdma_peripheral_connection_number)
	{
		...
		case GPDMA_CONN_ADCHS_WR:	function = 3; channel = 7; break;
		...
		case GPDMA_CONN_ADCHS_RD:	function = 3; channel = 8; break;
